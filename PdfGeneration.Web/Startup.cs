...
using PdfGeneration.Core.Banner;
using PdfGeneration.Core.Extensions;
using PdfGeneration.Core.Logging;
using PdfGeneration.Core.Sockets;
using PdfGeneration.Core.Upload;
using PdfGeneration.Data;
using PdfGeneration.Identity;
using PdfGeneration.Web.Hubs;
using PdfGeneration.Identity.Mock;
using System.Text;

namespace PdfGeneration.Web
{
